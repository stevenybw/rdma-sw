...
CC := sw5cc.new
CFLAGS  := -host -Wall -O3 -g -I/usr/sw-mpp/include -I/usr/sw-mpp/mpi2/include
...
src/iballputall: src/iballputall.c include/common.h
	mpicc -Wall -O3 -OPT:IEEE_arith=1 -o src/iballputall src/iballputall.c -I/usr/sw-mpp/include -Iinclude
